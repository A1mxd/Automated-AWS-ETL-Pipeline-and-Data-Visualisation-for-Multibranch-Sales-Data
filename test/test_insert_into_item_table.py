...
def test_inserts_new_item(mock_print):
    ...
    assert mock_print.call_args_list == [call('insert_into_item_table started'), 
                                         call('insert_into_item_table completed')]
    
@patch('builtins.print')
def test_skips_existing_item(mock_print):
